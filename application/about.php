...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/15-02-2018/trucking-demo_Free/973625046/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jun 2018 10:06:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title>Trucking a Transport Category Flat Bootstrap Responsive Website Template | About :: w3layouts</title>
    <!-- custom-theme -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="<?= base_url();?>siteassets/http://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">
    <link href="<?= base_url();?>siteassets/http://fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <!--bars -->
...
<body>
<script src='../../../../../../../ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js'></script><script src="<?= base_url();?>siteassets/../../../../../../../m.servedby-buysellads.com/monetization.js" type="text/javascript"></script>
<script>
    (function(){
...
<div class="banner">
    <nav class="navbar navbar-default">
        <div class="navbar-header navbar-left">
            ...
            <h1><a class="navbar-brand" href="<?= base_url();?>siteassets/index.html"><span><i class="fa fa-truck" aria-hidden="true"></i></span>TRUCKING</a></h1>
        </div>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
            <nav class="link-effect-2" id="link-effect-2">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<?= base_url();?>home"><span data-hover="Home">Home</span></a></li>
                    <li><a href="<?= base_url();?>about"><span data-hover="About Us">About Us</span></a></li>
                    <li><a href="<?= base_url();?>services"><span data-hover="Services">Services</span></a></li>
                    <li><a href="<?= base_url();?>product"><span data-hover="Services">Products</span></a></li>
                    <li><a href="<?= base_url();?>contact"><span data-hover="Contact Us">Contact Us</span></a></li>
                </ul>
            </nav>
        </div>
    </nav>
...
<div class="about-breadcrumb">
    <div class="container">
        <ul>
            <li><a href="<?= base_url();?>siteassets/index.html">Home</a><i>|</i></li>
            <li>About Us</li>
        </ul>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="signin-form profile">
                    ...
                    <p><a href="<?= base_url();?>siteassets/#" data-toggle="modal" data-target="#myModal3" > Don't have an account?</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="agile_inner_grids">
            ...
            <div class="col-md-6 w3_agileits_about_grid_right">
                ...
                <div id="chart">
                    ...
                    <ul id="bars">
                        <li><div data-percentage="56" class="bar"></div><span>2012</span></li>
                        <li><div data-percentage="33" class="bar"></div><span>2013</span></li>
                        <li><div data-percentage="54" class="bar"></div><span>2014</span></li>
                        <li><div data-percentage="94" class="bar"></div><span>2015</span></li>
                        <li><div data-percentage="44" class="bar"></div><span>2016</span></li>
                        <li><div data-percentage="23" class="bar"></div><span>2017</span></li>
                    </ul>
                </div>
            </div>
            <div class="clearfix"> </div>
    ...
    <div class="container">
        ...
        <div class="agileinfo-team-grids">
            <div class="col-md-3 wthree-team-grid">
                <img src="<?= base_url();?>siteassets/images/w1.jpg" alt="">
            ...
            <div class="col-md-3 wthree-team-grid">
                <img src="<?= base_url();?>siteassets/images/w2.jpg" alt="">
                <div class="wthree-team-grid-info">
                    <h4>Peter Parke</h4>
                    <p>Vestibulum</p>
                    <div class="team-social-grids">
            ...
            <div class="col-md-3 wthree-team-grid">
                <img src="<?= base_url();?>siteassets/images/w3.jpg" alt="">
                <div class="wthree-team-grid-info">
            ...
            <div class="col-md-3 wthree-team-grid">
                <img src="<?= base_url();?>siteassets/images/w4.jpg" alt="">
                <div class="wthree-team-grid-info">
                    <h4>Steven Wilson</h4>
                    <p>Vestibulum</p>
                    <div class="team-social-grids">
        ...
        <div class="sap_tabs">
            <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                ...
                <div class="resp-tabs-container">
                    <div class="tab-1 resp-tab-content">
                        <div class="view view-first">
                            <p>Donec libero dui, scelerisque ac augue id, tristique ullamcorper elit.
                                Nam ultrices, lacusvitae adipiscing aliquet, metus ipsum imperdiet libero,
                                vitae dignissim sapien diam ac nibh convallis. lorem ipsum dolor sit amet</p>
                            <h5>Businnes Man</h5>
                        </div>
                    </div>
                    <div class="tab-1 resp-tab-content">
                        <div class="view view-first">
                            <p>Scelerisque ac augue id Donec libero dui, tristique ullamcorper elit.
                                Nam ultrices, lacusvitae adipiscing aliquet, metus ipsum imperdiet libero,
                                vitae dignissim sapien diam ac nibh convallis. lorem ipsum dolor sit amet</p>
                            <h5>Analyst </h5>
                        </div>
                    ...
                    <div class="tab-1 resp-tab-content">
                        <div class="view view-first">
                            <p>Nam ultrices lacus vitae adipiscing aliquet, metus ipsum imperdiet libero,
                                vitae dignissim sapientristique Donec libero dui, scelerisque ac augue id,
                                ullamcorper elit,diam ac nibhconvallis. lorem ipsum dolor sit amet</p>
                            <h5>Transporter</h5>
                        </div>
                    </div>
                    <div class="tab-1 resp-tab-content">
                ...
                <ul class="resp-tabs-list">
                    <li class="resp-tab-item"><img src="<?= base_url();?>siteassets/images/t11.jpg" alt=""/></li>
                    <li class="resp-tab-item"><img src="<?= base_url();?>siteassets/images/t33.jpg" alt=""/></li>
                    <li class="resp-tab-item"><img src="<?= base_url();?>siteassets/images/t44.jpg" alt=""/></li>
                    <li class="resp-tab-item"><img src="<?= base_url();?>siteassets/images/t55.jpg" alt=""/></li>
                </ul>
                <div class="clearfix"></div>
            </div>
        </div>
...
<div class="w3-footer-contact">
    <div class="container">
        ...
        <div class="col-md-4 w3-footer-contact-right">
            ...
            <div class="col-md-10 w3-footer-contact-info">
                <p>Email:</p>
                <h4><a href="<?= base_url();?>siteassets/mailto:example@mail.com"> mail@example.com</a></h4>
            ...
            <ul id="flexiselDemo1">
                <li>
                    <div class="wthree_testimonials_grid_main">
                        ...
                        <img src="<?= base_url();?>siteassets/images/f1.png" alt=" " class="img-responsive" />
...
<div class="footer-final">
    <div class="copyw3-agile">
        <div class="container">
            <p>&copy; 2018 Ecopack | Design by <a href="http://aashvitech.com/">AashviInnovations</a></p>
        </div>
    </div>
</div>
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/15-02-2018/trucking-demo_Free/973625046/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jun 2018 10:06:22 GMT -->
</html>