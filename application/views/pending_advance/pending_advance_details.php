...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Pending Advance of Consignment</h2>
...
<script>
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            else
            {
                ...
                function(){
                    ...
                    $.ajax({
                        type: 'POST',
                       url: '<?php echo site_url('pending_advance/changestatus')?>',
                        cache: false,
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 1, "DESC" ]],
            "ajax": "<?php echo site_url('pending_advance/getrecord')?>"
        });
    }
