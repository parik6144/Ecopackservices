...
<script>
    ...
    {
        var itemID =  parseInt($(ref).closest("tr").find(".transitemName").val());
        var itemQty =  parseInt($(ref).closest("tr").find("input[name='transqty[]']").val());
        var advamt =  parseInt($(ref).closest("tr").find("input[name='transitemadvPrice']").val());
        var dueamt =  parseInt($(ref).closest("tr").find("input[name='transitemduePrice']").val());
        //alert(itemID);
        if(!isNaN(itemQty)){
...
//            alert(dueamt);
//            //advamount=(itemQty*advamt);
//            //advamount+ = (itemQty*advamt);
//            dueamount+=(itemQty*dueamt);
//            alert(advamount);
//            alert(dueamount);
        }
