...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            var refid=$(this).attr('refid');
                swal({
                title: "Are you sure?",
                text: "You want to Complete this LR!",
                type: "warning",
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('pending_consignment/changestatus')?>',
                    cache: false,
                    data: {"refid": refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url('pending_consignment/getrecord')?>"
        });
    }
