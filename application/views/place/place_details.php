                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated bounceInRight">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Place Form</h4>
                            <small class="font-bold"></small>
                        </div>
                        <div class="modal-body" id="place_modal_content">
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('place/addpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
                success: function (data) {
                    $("#place_modal_content").html(data);
                    $("#placeModal").modal();
        ...
        $(document).on("click",".btn_editrecord",function () {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('place/editpopup')?>',
                cache: false,
                async: false,
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('place/deleterecord')?>',
                    cache: false,
                    data: {delete: refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 1, "asc" ]],
            "ajax": "<?php echo site_url('place/getrecord')?>",
            "tableTools": {
