...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
                <form method="post" action="<?=base_url('consignment_report/getreport')?>">
            <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group"><label>consignee Name</label>
                            <select class="vehicle_inward_id form-control"  name="consignee_id" required="required">
                                <option value="">select consignmee</option>
                                <?php
