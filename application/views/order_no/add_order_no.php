        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>orderno Form</h5>
                    <span class="pull-right"><a href="<?php echo site_url('orderno') ?>"><i class="fa fa-angle-left"></i>Back</a> </span>
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_orderno">
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">Purchase Order No.</label>
                            <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    $("#btn_save_orderno").click(function () {
        ...
        if(validate(ref))
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('orderno/add')?>',
                cache: false,
                async: false,
