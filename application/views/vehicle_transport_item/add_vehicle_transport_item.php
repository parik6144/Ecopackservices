            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_rent_item">
                        <div class="form-group  row" style="    border: 0px solid #ddd; margin: -13px;"><label class="col-sm-3 control-label">Item Name</label>
                        ...
                        <div class="form-group  row"><label class="col-sm-3 control-label">Advance Price</label>
                            <div class="col-sm-9"><input type="number" class="form-control rec"  name="price"></div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group row"><label class="col-sm-3 control-label">Due Price</label>
                            <div class="col-sm-9"><input type="text" class="form-control"  name="due_price"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    ...
    $("#btn_save_rent_item").click(function () {
        ...
        if(validate(ref))
        {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('VehicleTransportitem/add')?>',
                cache: false,
                async: false,
