                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_vehicle">
                        <div class="form-group  row"><label class="col-sm-2 control-label">vehicle No.</label>
                            <div class="col-sm-10"><input type="text" class="form-control rec vehicle_no"  name="vehicle_no"></div>
                        </div>
...
<script type="text/javascript">
    ...
    $("#btn_save_vehicle").click(function () {
        ...
        if(validate(ref))
        {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('vehicle/add')?>',
                cache: false,
                async: false,
...
$(".vehicle_no").change(function(){
    ...
    $.ajax({
            type: 'POST',
            url: '<?php echo site_url('vehicle/validation')?>',
            cache: false,
            async: false,
