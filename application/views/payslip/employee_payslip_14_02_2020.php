													...
													<table class="tb-inner">
														<tbody>
															...
															<tr>
																<td>Casual Leave :</td>
																<td>
																<?php if(!empty($res->casual_leave)){ echo $res->casual_leave; } else { echo "0"; } ?>
																</td>
															</tr>
															<tr>
													...
													<table class="tb-inner-2">
														...
														<tbody>
															...
															<tr>
                                                                ...
                                                                ?>
																<td><?php if(!empty($advance_salary)){ echo $advance_salary; } else { echo 'N/A'; } ?></td>
															</tr>
															...
															<tr>
																...
																<td><?='N/A'?></td>
																<?php $netDeduction=$pf+$tax+$adv+$Leave; ?>
															</tr>
