...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10"><h2>Delivery Challan</h2></div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="<?php echo site_url('Deliverychallan') ?>"><i class="fa fa-angle-left"></i> View Records</a>
                    </div>
                </div>

                <?php } ?>
                <form id="frm_consignment" method="POST" action="<?=base_url('Deliverychallan/edit')?>">
                ...
                <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="form-group " style="display: none;"><label>Consignment Type</label>
                                ...
                                <div class="form-group row"><label class="col-sm-9 control-label">Consignee /Party GST No.</label>
                                ...
                                <div class="form-group row"><label class="col-sm-9 control-label">Way Bill No.</label>
                            ...
                            <div class="col-sm-4">
                                ...
                                <label>Delivery Challan No</label> : <span><?=$form_data['consignment']->dc_no?></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group  row" hidden="hidden"><label class="col-sm-3 control-label ">Bill Type</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row" hidden="hidden"><label class="col-sm-3 control-label">D.C No.</label>
                            ...
                            <div class="form-group  row"><label class="col-sm-3 control-label">Driver Mobile No.</label>
                                <div class="col-sm-9"><input type="text" readonly="readonly" class="form-control driver_mobile_no"  name="driver_mobile_no" value="<?=$form_data['consignment']->driver_no ?>"></div>
                            </div>

                        </div>
                        <div class="col-sm-7">
                            <div class="form-group  row" hidden="hidden"><label class="col-sm-3 control-label">Advance</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row" hidden="hidden"><label class="col-sm-3 control-label">Due</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row" hidden="hidden"><label class="col-sm-3 control-label">Employee</label>
                                <div class="col-sm-9">
                               ...
                               <div class="form-group  row"><label class="col-sm-3 control-label">vehicle Owner</label>
                                <div class="col-sm-9"><input type="text" readonly="readonly" class="form-control custom_control owner_name" name="owner_name" id="vehicle_owner" value="<?=$form_data['consignment']->ownername ?>"></div>
                            </div>
