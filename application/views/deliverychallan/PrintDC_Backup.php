                            ...
                            <tbody>
								<tr>
									<th class="text-center" colspan="10">
										...
										<span style="font-size: 12px; margin-bottom: 0;  font-weight: 700;"><b>(See rule 55 of GST Rules 2017)</b></span>
									...
									<td class="text-left" colspan="4">
									    <div class="logo-cnt">
    										...
    										<div class="address-lst">
									        	...
									        	<p style="font-size: 16px;  font-weight: 700;">H.No-15A, A-Road Zone No : 1B, Birsanagar, Telco Jamshedpur - 831019, Jharkhand</p>
    										</div>
									    </div>
