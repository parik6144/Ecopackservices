...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Employee Report Form</h5>
            
        </div>
        <div class="ibox-content">
                <form method="post" action="<?=base_url('employee_report/getreport')?>">
            <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group"><label>Employee Name</label>
                            <select class="vehicle_inward_id form-control"  name="employee_id" required="required">
                                <option value="">select Employee</option>
                                <?php
                                    // foreach ($consignee as $row) {
                                    //     echo "<option value='".$row['employee_id']."' type='outward_employee' >".$row['employee_name']."</option>";
                                    // }
                                    foreach ($inward_employee as $row) {
                                        echo "<option value='".$row['employee_id']."' type='inward_employee' >".$row['employee_name']."</option>";
                                    }
                                ?>
                            </select>
...
<script>
    ...
    $(".vehicle_inward_id").change(function(){
        $("#employee_type").val($(this).find("option:selected").attr("type"));
