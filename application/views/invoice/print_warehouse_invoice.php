...
<table class="tg">
  ...
  <?php 
    ...
    <?php $invoice_date = $record['invoice']->invoice_date; ?>
  ...
  <tr>
      ...
      if(($record['invoice']->invoice_date)>'2019-01-30')
      {
       ...
       <td class="tg-us36" colspan="3">
        <strong>Ware House Rent (<?= date("F", strtotime($record['invoice']->invoice_date)) ?>)</strong>
       </td>
      ...
      {
        ?>
        <td class="tg-us36" colspan="3"><strong>Ware House Rent <?=$invoice_date?> (<?=$long[date("m",strtotime($record['invoice']->invoice_date))]?>)</td>
        <?php 
      }
      ?> 
    ...
    <td class="tg-us36" ><strong>Warehouse Rent</strong></td>
