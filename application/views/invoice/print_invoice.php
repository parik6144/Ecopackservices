...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-c3ow">
    <?php
    if ($row['item_name'] === 'Output Shaft Insert 580*580*400 MM Poly Propline 6MM 1500 GSM (49 Pocket)(PM-COM-0619)') {
      echo '3923';
    } else {
      echo htmlspecialchars($record['tax_details']->hsn_code);
    }
    ?>
     </td>
