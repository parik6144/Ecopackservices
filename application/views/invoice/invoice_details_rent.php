...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Rent Invoice Records</h5>
            <div class="ibox-tools">
                <a href="<?= base_url('Deliverychallan')?>"><button class="btn btn-danger btn-circle btn-outline" id="btn_addrecord1" type="button"><i class="fa fa-plus-circle"></i>
                </button></a>
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="<?php echo site_url('Deliverychallan')?>">Add Record</a></li>
                </ul>
...
<script>
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 0, "DESC" ]],
            "ajax": "<?php echo site_url('invoice/getrecordrent')?>",
