...
<table class="tg">
  ...
  <tr>
    ...
    <th class="tg-us36" colspan="8">TAX INVOICE</th>

  </tr>

  <tr>

    <td class="tg-us36" colspan="4" rowspan="1" style="width:40%;">
  ...
  <tr>
    ...
    <?php
...

      {
        ...
        <td class="tg-us36" colspan="4">Dispatch Details: Annexure 1 </td>
...

      {
        ...
        <td class="tg-us36" colspan="4">Month of<strong> <?=$long[$monthnum+1]?></strong> </td>
        ...
        <td class="tg-us36" colspan="4">Month of<strong> <?=$long[date("n",strtotime($record['invoice']->invoice_date))]?></strong> </td>
  ...
  <tr>
    ...
    <td class="tg-c3ow"><?=round($row['attribute_value'])?></td>

    <td class="tg-c3ow"><?=$row['price']?></td>

    <td class="tg-dvpl"><?=number_format((float)($row['attribute_value']*$row['qty']*$row['price']), 2, '.', '')?></td>

  </tr>

  <?php

    $total+=$row['attribute_value']*$row['qty']*$row['price'];
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="7">Sub-Total</td>

    <td class="tg-dvpl"><?=number_format((float)($total), 2, '.', '');?></td>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="7">CGST @ <?=$record['tax_details']->tax_rate/2?>%</td>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="7">SGST  @ <?=$record['tax_details']->tax_rate/2?>%</td>
  ...
  <?php
...

    {
      ...
      <tr>
        ...
        <td class="tg-dvpl" colspan="7">IGST  @ <?=$record['tax_details']->tax_rate?>%</td>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="7">Total Tax</td>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="7">Round OFF</td>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="6">Invoice Value</td>
  ...
  <tr>
    ...
    <td class="tg-us36" colspan="8">Bill Amount in words - <span style="text-transform:capitalize"><?=getIndianCurrency($record['invoice']->invoice_total)?></span></td>

  </tr>

  <tr>

    <td class="tg-us36" colspan="8">Tax Amount in words - <span style="text-transform:capitalize"><?=getIndianCurrency($record['invoice']->total_tax)?></span></td>
  ...
  ECOPACK SERVICES PVT LTD<br>
    ...
    <td class="tg-us36" colspan="4" rowspan="3"><br><br><br>For,ECOPACK SERVICES PVT.LTD.</td>
