                                ...
                                <div class="table-responsive">
                                    <table class="table table-stripped table-bordered">
                                        ...
                                        foreach ($record as $row){
                                           ...
                                           <?php echo "<td><input type='checkbox' class='chkbox' name='transport_invoice_rate_id[]' value='".$row['transport_invoice_rate_id']."'>
                                                    <input type='hidden' class='hidden' name='consignor_id[]' value='".$row['consignor_id']."'>
                                                    <input type='hidden' class='hidden' name='consignee_id[]' value='".$row['consignee_id']."'>
                                                    <input type='hidden' class='hidden' name='bill_type[]' value='".$row['bill_type']."'>
                                                    <input type='hidden' class='hidden' name='data_type[]' value='".$row['data_type']."'>
                                                </td>";
                                            echo "</tr>";
                                            $ctr++;
                                            } ?>
