...
<table class="tg" style="width:100%;">
  ...
  <tr>
    ...
    <td class="tg-us36" colspan="4"><strong>Invoice No:- <?=$record['invoice']->invoice_no?></strong></td>
  </tr>
  ...
  <tr>
    ...
    <?php
      if($row['item_id']!="36"){
        ?>
        <td class="tg-c3ow tg-dvpl"><?=($row['qty']*34.4)?></td>
        <td class="tg-c3ow tg-dvpl"><?=($row['price']/34.4)?></td>
        <?php
      }
      else
      {
