            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_expense_head">
                        <input type="hidden" value="<?php echo $this->input->get('id'); ?>" name="expense_head_id">
                        <div class="form-group  row"><label class="col-sm-2 control-label">Expense Head Name</label>

                            <div class="col-sm-10"><input type="text" class="form-control rec" value="<?php if(isset($form_data['expense_head']['0']['expense_head_name'])) echo $form_data['expense_head']['0']['expense_head_name'];?>" name="expense_head_name"></div>
                        </div>
...
<script type="text/javascript">
    $("#btn_save").click(function () {
        ...
        if(validate(ref))
        {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('expense_head/edit')?>',
                cache: false,
                async: false,
