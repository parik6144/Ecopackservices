...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="modal inmodal" id="_employeeModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    function getrecord() {
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url('employee/getrecord')?>",
            dom: '<"html5buttons"B>lTfgitr<"pull-right"p>',
             "tableTools": {
               ...
               buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Employee Data Record'},
                    {extend: 'pdf', title: 'Employee Data Record'},
    ...
    $("#_employeeModal").on("hidden.bs.modal", function () {
