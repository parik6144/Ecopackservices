...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="modal inmodal" id="vehicle_inwardModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('vehicle_inward/addpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
                success: function (data) {
                    $("#modal_content").html(data);
                    $("#vehicle_inwardModal").modal();
        ...
        $(document).on("click",".btn_editrecord",function () {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('vehicle_inward/editpopup')?>',
                cache: false,
                async: false,
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('vehicle_inward/deleterecord')?>',
                    cache: false,
                    data: {delete: refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url('vehicle_inward/getrecord')?>",
    ...
    $("#vehicle_inwardModal").on("hidden.bs.modal", function () {
