                    ...
                    <form method="POST" class="form-horizontal">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group"><label class=" control-label" >Company Name</label>
                                    <div class=""><input type="text" class="form-control rec"  name="company_name"></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group"><label class=" control-label" >Contact Person Name</label>
                                    <div class=""><input type="text" class="form-control rec"  name="contact_person_name"></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group"><label class=" control-label" >Project Name</label>
                                    <div class=""><input type="text" class="form-control rec"  name="project_name"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-3 control-label" >Company Address</label>
                                    ...
                                    <div class="col-sm-9"><textarea class="form-control" name="company_address" rows="3"></textarea></div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group  row"><label class="col-sm-12 control-label"  style="text-align:left;">Rotation Per Month</label>
                                ...
                                <div class="col-sm-12"><input type="text" class="form-control rec rotation_per_month"  name="rotation_per_month"></div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                                    ...
                                    <table class="table table-stripped">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td ><input type="text" name="interest_rate" value="24" class="form-control disabled assets_interest"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col-sm-5">
                                <table class="table table-stripped">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td>Interest In %</td>
                                                <td ><input type="text" name="operation_rate" value="12" class="form-control disabled operation_interest"></td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
...
<script type="text/javascript">
 ...
 '                                              </tr>  ' ; 
    ...
    $(".btn_calculate").click(function(){
        ...
        $(".total_asset_value").val(asset_total);
        /*custom*/
        var a = asset_total;
