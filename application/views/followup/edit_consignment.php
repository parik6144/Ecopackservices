                    ...
                    <form id="frm_consignment" method="POST" action="<?=base_url('consignment/edit')?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped table-bordered">
                                ...
                                <tfoot id="product_td">
                                    <tr>
                                        <td colspan="3"><h4 class="tet-center">Stock Item</h4></td>
                                    </tr>
                                    <?php
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="form-group  row"><label class="col-sm-3 control-label">Vehicle No</label>
                                <div class="col-sm-9"><select class="form-control rec custom_control" name="vehicle_id" id="vehicle_no">
                            ...
                            <div class="form-group  row"><label class="col-sm-3 control-label">Way Bill No.</label>
                                <div class="col-sm-9"><input type="text" class="form-control rec custom_control" value="<?=$form_data['consignment']->way_bill_no ?>"  name="way_bill_no"></div>
                            </div>
     ...
     $("#vehicle_no").change(function(){
        ...
        if(vehicle_id!="" && consignee_id!="" && bill_type!="")
        {
            $.ajax({
                ...
                cache: false,
                async: false,
                data: {vehicle_id:vehicle_id,consignee_id:consignee_id,bill_type:bill_type},
                success: function (data) {
