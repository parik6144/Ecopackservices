...
class Mdl_place extends CI_Model{
    ...
    public function saveplace($post)
    {
        ...
        $data=array("place_name"=>$place_name,"place_code"=>$place_code,"created_by"=>$user_id,"created_datetime"=>$datetime);
    ...
    public function getplace($start="",$length="",$searchstr="",$column,$type)
    {
        ...
        {
            $this->db->select('place_id,place_code,`place_name`');
