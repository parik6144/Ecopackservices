<?php
class Pending_due extends CI_Controller
{
    ...
    public function index()
    {
       ...
       echo  $data['total']=$this->Mdl_pending_due->gettotaldue(); exit;
        $this->load->view('pending_due/pending_due_details',$data);
    }

    public function changestatus()
    {
        $refid=encryptor("decrypt",$_POST['refid']);
        $this->Mdl_pending_due->changestatus($refid);
        echo "true";
    }
    ...
    public function getrecord()
    {
        ...
        $temp=$this->Mdl_pending_due->getconsignment($start,$length,$searchstr['value'],$orderfield['0']['column'],$orderfield['0']['dir']);
