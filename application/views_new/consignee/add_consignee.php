        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Consignee Form</h5>
                    <span class="pull-right"><a href="<?php echo site_url('consignee') ?>"><i class="fa fa-angle-left"></i>Back</a> </span>
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_consignee">
                        ...
                        <div class="form-group  row"><label class="col-sm-3 control-label">Consignee Name</label>
                            <div class="col-sm-9"><input type="text" class="form-control "  name="consignee_name"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
