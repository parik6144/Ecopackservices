                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated bounceInRight">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Consignee Form</h4>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('consignee/addpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
                success: function (data) {
                    $("#consignee_modal_content").html(data);
        ...
        $(document).on("click",".btn_editrecord",function () {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('consignee/editpopup')?>',
                cache: false,
                async: false,
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('consignee/deleterecord')?>',
                    cache: false,
                    data: {delete: refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 2, "asc" ]],
            "ajax": "<?php echo site_url('consignee/getrecord')?>",
             ...
             "tableTools": {
               ...
               buttons: [
                    { extend: 'copy'},
                    {extend: 'csv', title: 'Consignee Data Records'},
                    {extend: 'excel', title: 'Consignee Data Records'},
                    {extend: 'pdf', title: 'Consignee Data Records'},
