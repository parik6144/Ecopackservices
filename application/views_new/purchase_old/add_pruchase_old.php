                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group  row" id="data_1">
                                    <label class="font-noraml">Invoice Date</label>
                                    <div class="input-group date">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control invoice_date" value="<?=date("d-m-Y");?>">
                                    </div>
                                </div>
                                 <div class="form-group  row"><label>Invoice No</label> <input type="text" class="form-control invoice_no" id="invoice_no"></div> 
                                <div class="form-group  row"><label>Address : </label> L5 Quarter, O no 6, Kalang Road kadma, jamshedpur</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody id="product_td">
                                    <tr>
                                        ...
                                        <td><input type="text" name="" class="form-control sale_price" placeholder="Sale Price"></td>
    ...
    $(".accountName").change(function(){
        ...
        $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(record['account']['0']['account_name']);
 ...
 '                                              </div></td>          '  + 
    ...
    $(document).on("change",".itemName",function(){
        ...
        $.ajax({
                ...
                success: function (data) {
                    var record=JSON.parse(data);
                    console.log(record.item['0']['sale_price']);
                    ref.parent().parent().find(".sale_price").val(record.item['0']['sale_price']);
    ...
    function calculatetotal(ref)
    {
        ...
        var price=parseFloat(ref.closest('tr').find(".sale_price").val()).toFixed(2);
        var tax=0;
    ...
    $(".btn_save").click(function(){
        var products           =   {"productData":[],"invoicedate":[]};
        ...
        $('#product_td tr').each(function(index)
        {
            if($(this).find('.itemName').val()!="")
            {
                products.productData.push({
                    ...
                    "sale_price":$(this).find('.sale_price').val(), 
        ...
        $.ajax({
                type: 'POST',
                url: '<?php echo site_url('invoice/saveinvoice')?>',
                cache: false,
                async: false,
                data: {data:products},
                success: function (data) {
