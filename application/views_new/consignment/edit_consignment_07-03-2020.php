                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped table-bordered">
                                ...
                                <tfoot id="product_td">
                                    ...
                                    <tr>                                        
                                        <td>
                                            <select class="itemName form-control" name="item_id[]" onchange="getItemPricebyConsingee(this);">
                                        ...
                                        <script> var ItemRentID = <?php Print($stockitem['item_id']); ?>; getItemPricebyConsingee(ItemRentID);</script>
