...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Consignment Records</h5>
            <div class="ibox-tools">
                <a href="<?= base_url('consignment/add')?>"><button class="btn btn-danger btn-circle btn-outline" id="btn_addrecord1" type="button"><i class="fa fa-plus-circle"></i>
                </button></a>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover dataTables-example" id="example" style="width:1500px;">
                <thead>
                <tr role="row">
                    <th>&nbsp;</th>
...
<script>
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 1, "DESC" ]],
            "ajax": "<?php echo site_url('consignment/getrecord')?>",
             dom: '<"html5buttons"B>lTfgitr<"pull-right"p>',
             "tableTools": {
                "sSwfPath": "<?php echo base_url() ?>assets/js/plugins/dataTables/swf/copy_csv_xls_pdf.swf"
            },
               buttons: [
                    { extend: 'copy',title: 'Consignment Data Records'},
                    {extend: 'csv' ,title: 'Consignment Data Records'},
                    {extend: 'excel', title: 'Consignment Data Records'},
                    {extend: 'pdf', title: 'Consignment Data Records'},
