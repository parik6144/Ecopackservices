        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>holiday Form</h5>
                    <span class="pull-right"><a href="<?php echo site_url('holiday') ?>"><i class="fa fa-angle-left"></i>Back</a> </span>
                </div>
                <?php } ?>
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_holiday">
                        <div class="form-group  row"><label class="col-sm-2 control-label">Holiday Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control rec"  name="holiday_name">
                            </div>
                        </div>
                        ...
                        <label class="col-sm-2">Holiday Date</label>
                            <div class="input-group date col-sm-10 " id="data_1">
                                ...
                                <input type="text" name="holiday_date" class="form-control stock_date rec" value="<?=date("d-m-Y");?>">
                            </div>
                        <div class="hr-line-dashed"></div>
                        <button type="button" class="btn btn-success" id="btn_save_holiday">Save</button>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    $("#btn_save_holiday").click(function () {
        ...
        if(validate(ref))
        {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('holiday/add')?>',
                cache: false,
                async: false,
