                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class=" form-control rec"  id="warehouse_id" name="warehouse_id" required="required">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Consignor /Source Place</label>
                                    <select class="consignor_place rec form-control"  name="source_id" id="source_id">
                                        <option value=''>Select Consignor  Place</option>
                            ...
                            <div class="col-sm-4">
                            <div class="form-group"><label class=" control-label">Consignee / Party GST No.</label>
...
<script>
    ...
    $(document).on("change",".qty",function(){
        ...
        if(itemID>0 && no_of_stock<=crstock) {
            var htmlstr = '<div class="col-sm-3">' +
                '<label class="control-label ">Barcode :</label>  ' +
                '</div>  ' +
                '<div class="col-sm-9" style="padding: 5px;">  ' +
                '<input class="form-control txt_barcode" name="item_barcode[]" type="text" required="required">  ' +
                '</div>';
