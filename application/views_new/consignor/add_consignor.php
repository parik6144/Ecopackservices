        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Consignor Form</h5>
                    <span class="pull-right"><a href="<?php echo site_url('consignor') ?>"><i class="fa fa-angle-left"></i>Back</a> </span>
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_consignor">
                        ...
                        <input type="hidden" value="<?php echo $this->input->get('id'); ?>" name="uom_id">
                            <div class="col-sm-9"><input type="text" class="form-control "  name="consignor_name"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row"><label class="col-sm-3 control-label">Party Name</label>
                            <div class="col-sm-9"><input type="text" class="form-control "  name="party_name"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    ...
    $("#btn_save_consignor").click(function () {
        ...
        if(validate(ref))
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('consignor/add')?>',
                cache: false,
                async: false,
