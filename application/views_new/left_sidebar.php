...
<nav class="navbar-default navbar-static-side" role="navigation">
  ...
  || (!empty($this->Mdl_setting->is_access($this->session->userdata('user_id'),3,11,'is_view'))) || (!empty($this->Mdl_setting->is_access($this->session->userdata('user_id'),3,12,'is_view'))) || (!empty($this->Mdl_setting->is_access($this->session->userdata('user_id'),3,9,'is_view')))
...
<!--                </ul>-->
        ...
        <?php } ?>
            ...
            <li class="">
                <a href="#"><i class="fa fa-bar-chart-o"></i> Assets Manager<span class="fa arrow"></a>
                <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">

                    <li>
                    <a href="<?php echo site_url('branch'); ?>" ><i class="fa fa-marker"></i>Item<span class="fa arrow"></a>
                    <ul class="nav nav-third-level collapse" aria-expanded="false" style="height: 0px;">
                       <li><a href="<?php echo site_url('itemmaster'); ?>" ><i class="fa fa-marker"></i>New Rent Item</a></li>
<!--                        <li><a href="--><?php //echo site_url('Item/Transport'); ?><!--" ><i class="fa fa-marker"></i>Transport Item</a></li>-->
<!--                        <li><a href="--><?php //echo site_url('Item/Rent'); ?><!--" ><i class="fa fa-marker"></i>New Rent Item</a></li>-->
                    </ul>
                    </li>

                    <li><a href="<?php echo site_url('Warehouse/locations'); ?>" ><i class="fa fa-marker"></i>Warehouse</a></li>
                    <li><a href="<?php echo site_url('Place'); ?>" ><i class="fa fa-marker"></i>Locations</a></li>

                    <li><a href="<?php echo site_url('stocktransfer'); ?>" ><i class="fa fa-marker"></i>Stock Transfer</a></li>

                    <li><a href="#" ><i class="fa fa-marker"></i>Purchase</a>
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li><a href="<?php echo site_url('payment_booking/Purchase'); ?>" ><i class="fa fa-marker"></i>New Purchase</a></li>
                            <li><a href="<?php echo site_url('payment_booking/purchaseRecords'); ?>" target="_blank"><i class="fa fa-marker"></i>List Records</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="#" ><i class="fa fa-marker"></i>Barcode</a>
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li><a href="<?php echo site_url('Barcode/Pending'); ?>" ><i class="fa fa-marker"></i>Pending Barcode</a></li>
                            <li><a href="<?php echo site_url('Barcode'); ?>" ><i class="fa fa-marker"></i>Barcode List</a></li>
                        </ul>
                    </li>
            ...
            <li>
                <a href="<?php echo site_url('inward'); ?>" ><i class="fa fa-marker"></i>Inward</a>
            </li>
