            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_warehouse">
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">warehouse Code34567</label>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">Warehouse City</label>
                            <div class="col-sm-10">
                                <select name="warehouse_city" class="form-control rec">
                                    <?php
                                    $placeID=$form_data['warehouse']['0']['place_id'];
                                    foreach($places as $res): ?>
                                        <option value="<?=$res['place_id']?>" <?php if($placeID==$res['place_id']){ echo 'selected'; } ?>><?=$res['place_name']?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
        ...
        if(validate(ref))
        {
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    swal("","Record Updated Failed","danger");
