            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_warehouse">
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">Warehouse Name</label>
                            <div class="col-sm-10"><input type="text" class="form-control"  name="name_warehouse"></div>
                        </div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">Warehouse City</label>
                            ...
                            <select name="warehouse_city" class="form-control rec">
                               ...
                               <option value="<?=$res['place_id']?>"><?=$res['place_name']?></option>
                                <?php endforeach; ?>
                            </select>
                            </div>
                        </div>
