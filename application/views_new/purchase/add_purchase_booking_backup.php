        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Purchase Booking Form</h5>
                    <span class="pull-right btn-default"><a href="<?php echo site_url('payment_booking') ?>"><i class="fa fa-angle-left"></i>View Records</a> </span>
                </div>
                <?php } ?>
                    ...
                    <form method="POST" class="form-horizontal" id="frm_payment_booking">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="form-group  row advance_salary"><label class="col-sm-2 control-label">Month</label>
                                    <div class="col-sm-10">
                                        <select class="form-control"  name="advance_salary_month">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control rec expense_head" name="expense_head">
                                            ...
                                            <?php foreach ($expense_head as $row){ ?>
                                                <option value="<?=$row['expense_head_id']?>" <?php if($row['expense_head_id']==16) echo 'selected';  ?>><?=$row['expense_head_name']?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group  row"><label class="col-sm-2 control-label">TDS</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group  row"><label class="col-sm-2 control-label">Taxable Value</label>
                                    <div class="col-sm-10"><input type="number" class="form-control rec taxable_value"  name="taxable_value"></div>
                                </div>

                                <div class="form-group  row"><label class="col-sm-2 control-label">Tax</label>
                                    <div class="col-sm-10"><input type="number" class="form-control rec purchase_tax"  name="purchase_tax"></div>
                                </div>

                                <div class="form-group  row"><label class="col-sm-2 control-label">Invoice Total</label>
                                    <div class="col-sm-10"><input type="number" class="form-control rec amount"  name="amount"></div>
                                </div>
                        ...
                        <div class="hr-line-dashed advance_salary"></div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 control-label">Vehicle No</label>
                            <div class="col-sm-10">
                                <select class="form-control vehicle_no"  name="vehicle_id" style="width: 100%">
                                    <option value="">None</option>
                                    <?php
                                    foreach ($vehicle_no as $row){
                                        ?>
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row item_table"><label class="col-sm-2 control-label">Warehouse</label>
                            <div class="col-sm-10">
