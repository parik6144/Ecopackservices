...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10"><h2>Purchase Records</h2></div>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                <a href="<?=base_url('payment_booking/purchase')?>"><button class="btn btn-danger btn-circle btn-outline" id="" type="button"><i class="fa fa-plus-circle"></i>
                </button></a>
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="<?php echo site_url('payment_booking/purchase')?>">Add Record</a>
                    </li>
                </ul>
        ...
        <div class="ibox-content">
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" id="example" style="height: 800px; overflow-y: scroll;">
                <thead>
                <tr role="row">
                    <th>&nbsp;</th>
                    <th>Purchase Date</th>
