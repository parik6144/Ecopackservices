                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_employee_salary">
                        <div class="form-group  row"><label class="col-sm-3 control-label">Employee</label>
                            <input type="hidden" value="<?=$_GET['id']?>" name="salary_id">
                            <div class="col-sm-9">
                                <select class="form-control" name="staff_id">
                                    ...
                                    <?php
                                        foreach ($staff as $row) {
                                            $str="";
                                            if($row['staff_id']==$form_data['employee_salary']['0']['staff_id'])
                                                $str="selected='selected'";
                                            echo '<option value="'.$row['staff_id'].'" '.$str.'>'.$row['emp_no']." ".$row['staff_name'].'</option>';
                                        }
                                    ?>
                        ...
                        <div class="form-group  row"><label class="col-sm-3 control-label">BASIC</label>
                            ...
                            <div class="col-sm-9"><input type="text" class="form-control rec" value="<?=$form_data['employee_salary']['0']['basic']?>"  name="basic"></div>
                        </div>
                        
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row"><label class="col-sm-3 control-label">DA</label>

                            <div class="col-sm-9"><input type="text" class="form-control"  value="<?=$form_data['employee_salary']['0']['da']?>"  name="da"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        
                        <div class="form-group  row"><label class="col-sm-3 control-label">HRA</label>

                            <div class="col-sm-9"><input type="text" class="form-control"  value="<?=$form_data['employee_salary']['0']['hra']?>"  name="hra"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                       <div class="form-group  row"><label class="col-sm-3 control-label">CEA</label>
                            <div class="col-sm-9"><input type="text" class="form-control " value="<?=$form_data['employee_salary']['0']['cea']?>"  name="cea"></div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group  row"><label class="col-sm-3 control-label">TPA</label>
                            <div class="col-sm-9"><input type="text" class="form-control " value="<?=$form_data['employee_salary']['0']['tpa']?>"   name="tpa"></div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group  row"><label class="col-sm-3 control-label">OT per Hour</label>
                            <div class="col-sm-9"><input type="text" class="form-control"  value="<?=$form_data['employee_salary']['0']['ot_per_hour']?>"  name="ot"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    ...
    $("#btn_save_employee_salary").click(function () {
        ...
        if(validate(ref))
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('employee_salary/edit')?>',
                cache: false,
                async: false,
