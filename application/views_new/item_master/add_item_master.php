            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_item">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row"><label class="col-sm-3 control-label">Item Tax</label>
                            <div class="col-sm-9"><input type="number" class="form-control"  name="tax"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <?php
                        foreach ($warehouse as $row) {
                            # code...
                        ?>
                                <div class="form-group  row" style="display: none;"><label class="col-sm-3 control-label"><?=$row['warehouse_name']?> OP Stock</label>
                                    <div class="col-sm-9">
