                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_item">
                       ...
                       <div class="form-group  row"><label class="col-sm-3 control-label">Price</label>
                        ...
                        <div class="form-group  row"><label class="col-sm-3 control-label">Tax</label>
                            <div class="col-sm-9"><input type="text" class="form-control rec"  name="tax" value="<?=$form_data['item']['0']['tax']?>"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <?php
