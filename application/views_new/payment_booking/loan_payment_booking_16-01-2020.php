                    ...
                    <form method="POST" class="form-horizontal" id="frm_payment_booking" action="<?php echo site_url('payment_booking/add') ?>">
                        <div class="form-group  row"><label class="col-sm-2 control-label">Amount</label>
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control rec" value="<?=$form_data['loan']['0']['monthly_emi']?>" name="amount"></div>
                        </div>
                        ...
                        if($arr['1']=="1")
                            ...
                            $prevmonth=$arr['1']-1;
                        ?>
                        <input type="text" name="remarks" value="Interest on loan from <?=$arr['0'].'-'.$prevmonth.'-'.$arr['2']. ' to '.$arr['0'].'-'.$arr['1'].'-'.$arr['2']?>">
