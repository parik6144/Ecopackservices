...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="modal inmodal" id="vehicleModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated bounceInRight">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>

                            <h4 class="modal-title">Transport Invoice Rate Form</h4>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('transport_invoice_rate/addpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
        ...
        $(document).on("click",".btn_editrecord",function () {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('transport_invoice_rate/editpopup')?>',
                cache: false,
                async: false,
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('transport_invoice_rate/deleterecord')?>',
                    cache: false,
                    data: {'delete': refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 1, "asc" ]],
            "ajax": "<?php echo site_url('transport_invoice_rate/getrecord')?>",
