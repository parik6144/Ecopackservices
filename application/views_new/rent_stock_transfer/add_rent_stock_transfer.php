            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_rentstocktransfer">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row"><label class="col-sm-2 control-label">LR NO</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="consignment_id">
...
<script type="text/javascript">
    ...
    $("#btn_save_rentstocktransfer").click(function () {
        ...
        if(validate(ref))
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('rentstocktransfer/add')?>',
                cache: false,
                async: false,
