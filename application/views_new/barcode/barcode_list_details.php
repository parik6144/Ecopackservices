...
<div class="col-lg-12">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Items Barcode Records</h5>
            <div class="ibox-tools">
            <!--   <button class="btn btn-danger btn-circle btn-outline" id="btn_addrecord" type="button"><i class="fa fa-plus-circle"></i></button>-->
...
<script>
    $(document).ready(function() { getrecord(); });
    function getrecord() {
        $('#example').DataTable( {
            responsive: true,
            "processing": true,
            "serverSide": true,
            "order": [[ 1, "asc" ]],
            "ajax": "<?php echo site_url('Barcode/getrecordbarcodeitems')?>",
             ...
             "tableTools": {
               ...
               buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Barcode List Data Record'},
                    {extend: 'pdf', title: 'Barcode List Data Record'},
                    {extend: 'print',
