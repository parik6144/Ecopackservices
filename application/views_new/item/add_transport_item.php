                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_item">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Transport Item Name</label>
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label">Opening Stock</label>
