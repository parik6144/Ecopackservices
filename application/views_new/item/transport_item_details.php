                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated bounceInRight">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Transport Item Form</h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('item/addtransportpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 2, "asc" ]],
            "ajax": "<?php echo site_url('item/gettransportrecord')?>",
