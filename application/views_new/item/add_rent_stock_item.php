                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" id="frm_item">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Rent Item Name</label>
                            <div class="col-sm-9">
                                <select name="item_name" class="form-control rec">
                                    <option value="">Select Item</option>
                                    <?php
                                        foreach ($item as $row){
                                            echo "<option value='".$row['master_item_id']."'>".$row['item_name']."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
...
<!--                        <div class="hr-line-dashed"></div>-->
                        ...
                        <div class="form-group  row" style="display:none;"><label class="col-sm-3 control-label">Item Type</label>
                            <div class="col-sm-9">
                                <select class="form-control rec" name="item_type">
                        ...
                        <div class="form-group  row"><label class="col-sm-3 control-label">Warehouse Opening Stock</label>
                            <div class="col-sm-9"><input type="number" class="form-control"  name="warehouse_opening_stock"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    ...
    $("#btn_save_item").click(function () {
        ...
        if(validate(ref))
        {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('item/add')?>',
                cache: false,
                async: false,
