...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Rent Item Records</h5>
            <div class="ibox-tools">
                <button class="btn btn-danger btn-circle btn-outline" id="btn_addrecord1" type="button"><i class="fa fa-plus-circle"></i>
                </button>
...
<script>
    ...
    function getrentrecord() {
        $('#example_rent').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 2, "asc" ]],
            "ajax": "<?php echo site_url('item/getrentrecord2')?>",
            "tableTools": {
