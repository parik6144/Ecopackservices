...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('vehicle/addpopup')?>',
                cache: false,
                async: false,
                data: {popup:'popup'},
        ...
        $(document).on("click",".btn_editrecord",function () {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url('vehicle/editpopup')?>',
                cache: false,
                async: false,
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('vehicle/deleterecord')?>',
                    cache: false,
                    data: {delete: refid},
                    success: function (data) {
                        if(data=="true")
    ...
    function getrecord() {
        $('#example').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url('vehicle/getrecord')?>",
