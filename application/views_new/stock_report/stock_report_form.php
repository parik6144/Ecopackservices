...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
             <form method="post" action="<?=base_url('stock_report/getreport')?>">
            <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group"><label>Consignor Type</label>
                            <select class="consignor_type form-control"  name="consignor_type" required="required">
