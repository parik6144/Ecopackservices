...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="modal inmodal" id="inward_Modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content animated bounceInRight">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>

                            <h4 class="modal-title">Inward  Form</h4>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_addrecord").click(function () {
            //alert("ok");
            window.location="<?=base_url('inward/add')?>";
        });
        ...
        $(document).on("click",".btn_deleterecord",function (e) {
            ...
            function(){
                ...
                $.ajax({
                    type: 'POST',
                   url: '<?php echo site_url('inward/deleterecord')?>',
                    cache: false,
                    data: {delete: refid},
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 0, "DESC" ]],
            "ajax": "<?php echo site_url('inward/getrecord')?>",
    ...
    $("#inward_Modal").on("hidden.bs.modal", function () {
