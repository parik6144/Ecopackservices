                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" id="itemsbarcode" name="itemsbarcode" class="required">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-info bar_close" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $(document).on("change",".qty",function(){
        modalitemid=$(this).closest("tr").find(".itemName").val();
        ref=$(this);
        var no_of_stock=parseInt($(this).val());
        var itemID=parseInt($('.itemName').val());
        //var crstock = parseInt($(this).closest("tr").find(".itemName option:selected").attr("stock")); alert('crstock '+crstock);
...
<script>
    $('#bar_close').click(function() {
        alert(456789);
        $("#testform").valid(); //validate form 1
    });
</script>
