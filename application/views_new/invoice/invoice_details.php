    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <a href="<?= base_url('invoice/add')?>"><button class="btn btn-danger btn-circle btn-outline" id="btn_addrecord1" type="button"><i class="fa fa-plus-circle"></i>
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li><a href="<?php echo site_url('invoice/add')?>">Add Record</a>
...
<script>
    ...
    function getrecord() {
        ...
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 0, "DESC" ]],
            "ajax": "<?php echo site_url('invoice/getrecord')?>",
            dom: '<"html5buttons"B>lTfgitr<"pull-right"p>',
             "tableTools": {
               ...
               buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Invoice Data Records'},
                    {extend: 'pdf', title: 'Invoice Data Records'},
