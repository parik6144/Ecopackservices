...
<table class="tg">
  ...
  <tr>
      ...
      if(($record['invoice']->invoice_date)>'2019-01-30')
      {
        ...
        ?>
        <td class="tg-us36" colspan="3"><strong>Ware House Rent (<?=$long[$monthnum+1]?>)</td>
        <?php
      }
      else
      {
        ?>
        <td class="tg-us36" colspan="3"><strong>Ware House Rent (<?=$long[date("n",strtotime($record['invoice']->invoice_date))]?>)</td>
