...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Due Payment of Consignment</h2>
...
<script>
    ...
    function getrecord() {
        $('#example').DataTable( {
            ...
            "serverSide": true,
            "order": [[ 1, "DESC" ]],
            "ajax": "<?php echo site_url('due_payment/getrecord')?>",
            dom: '<"html5buttons"B>lTfgitr<"pull-right"p>',
             "tableTools": {
               ...
               buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Due Payment Data Records'},
                    {extend: 'pdf', title: 'Due Payment Data Records'},
